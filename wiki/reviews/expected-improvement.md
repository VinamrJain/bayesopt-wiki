...
- [expected-improvement-1] blocker (open) — Broken wikilink [[ego-convergence-rates]] (line 168). No such note exists in wiki/; the convergence-theory note bull2011 supports is not present at all. The link renders dead. Either create the convergence-rates note or drop the [[...]] and keep the prose reference to bull2011 as a plain inline citation until that note exists.
