...
\newcommand{\imarrwthree}{2.24in}
\newcommand{\imhspthree}{-0.10in}
...
We wish to find the maximiser $\xopt = \argmax_{x\in\Xcal} f(x)$.
...
\begin{figure}
\centering
\includegraphics[width=1.8in]{figs/gp_bw_sample}
\vspace{\imcaptionspace}
\caption{\small
\label{fig:gpBWSample}
Samples drawn from a GP with $0$ mean and SE kernel with bandwidths $h=0.1,h=0.15,0.5$.
