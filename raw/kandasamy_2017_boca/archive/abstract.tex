...
\begin{abstract}
Bandit optimisation methods for black-box optimisation, such as Bayesian optimisation, 
...
In many practical applications however, a continuous spectrum of approximations might be
available.
...
Here, the approximations arise out of a continuous $2$ dimensional space $(N,T)$.
